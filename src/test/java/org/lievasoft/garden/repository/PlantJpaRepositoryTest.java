...
//            var preserved = Situation.PRESERVED;
//            int limit = 8;
//            int offset = 0;
//
//            List<CardResponseDto> plantCardsActual = plantJpaRepository.findPlantCardsBySituation(limit, offset, preserved.name());
//
//            assertAll(
...
//
//        List<CardResponseDto> actual = underTest.findPlantCardsBySituation(PAGE_LIMIT, offset, null);
//
